...
namespace Skontrum
{
    public partial class FormKsiazkaZPolki : Form
    {
        public FormKsiazkaZPolki()
        {
            InitializeComponent();
        }
        ...
        {
            bool rezultat = KatalogKsiazek.DodajKsiazke(int.Parse(textBox1.Text), "polka", textBox2.Text);
            if (rezultat == false)
            {
